...
AGENT_JWT_EXPIRY_MINUTES = 60  # Short-lived access tokens
...
class AgentJWTService:
    ...
    def generate_agent_jwt(self, agent_role: str) -> str:
        ...
        logger.info(f"Generated 60-minute access token for agent role: {agent_role}")
        return token
...
def generate_access_token(agent_role: str, service_id: str) -> str:
    """Generate 60-minute access token for authenticated service"""
